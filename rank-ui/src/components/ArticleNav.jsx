...
export default function ArticleNav({ isAuthed, user, onNavigateDashboard, onNavigateSignals, onNavigateOpportunities, onNavigateAnalytics, onLogout, onSignUp, onLogIn }) {
    return (
