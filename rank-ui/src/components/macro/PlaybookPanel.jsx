export default function PlaybookPanel({ playbook = {} }) {
    ...
    return (
        <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-4">
            <h2 className="text-sm font-semibold text-slate-200">Playbook</h2>
            <div className="mt-3 grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                    <div className="text-xs uppercase tracking-wide text-emerald-300">Favored Assets</div>
                ...
                <div>
                    <div className="text-xs uppercase tracking-wide text-rose-300">Unfavorable Assets</div>
                    <ul className="mt-1 space-y-1 text-slate-300">
            ...
            <p className="mt-3 text-sm text-slate-400">{playbook.notes || "No notes available."}</p>
        </section>
    );
}
